...
t1 = netleague(net,net, digits = 2, 
               seq = c("Placebo", "Ropinirole","Bromocriptine","Cabergoline","Pramipexole")) # writexl=TRUE
t2 = t1$fixed
t2
```
...
```{r}
dd = data.frame(round(gene_dd(fit$beta[,12]), 2))
colnames(dd) = "differences"
rownames(dd) = c("12", "13", "14", "15", "23", "24", "25", "34", "35", "45")
dd[c("15", "12", "13", "14"),]
-dd[c("25", "35", "45"),]
dd[c("23", "24"),]
dd[c("34"),]
