...
X = rbind(c(0,1,0,0), 
           ...
           c(0,0,-1,1), 
           c(0,0,1,0))
y = c(-0.31, -1.7, -0.35, 0.55, -0.3, -0.3, -0.9)
sigma = c(0.668089651, 0.382640605, 0.441941738, 0.555114559, 0.274276316, 
          0.320087245, 0.694988091)
```


Using data set instead of typing:
```{r}
library(meta)
library(netmeta)
```
